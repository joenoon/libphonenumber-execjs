...
(function() {
  ...
  this.getE164PhoneNumber = function(str, cc, ndc) {
    var attempt, e164, fixnumber, format, inst, num, phone, regionCode, util;
    cc = "" + (cc != null ? cc : "");
    ndc = "" + (ndc != null ? ndc : "");
    ...
    format = function(phone_obj) {
      if (phone_obj) return inst.format(phone_obj, e164);
    };
    attempt = function(fn) {
      return format(fixnumber(falsy(fn)));
    };
    phone = attempt(function() {
